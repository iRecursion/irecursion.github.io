...
function() {
  ...
  function i(e) {
    ...
    s = (s.contains = [o, l, t, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a, e.C_BLOCK_COMMENT_MODE], r.contains = [c, l, i, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a, e.inherit(e.C_BLOCK_COMMENT_MODE, {
      illegal: /\n/
    })], {
  ...
  function o(e) {
    ...
    s = [r, s, i, e.HASH_COMMENT_MODE, o, l, {
      begin: "::"
    },
    {
      className: "symbol",
  ...
  function g(e) {
    ...
    return {
      ...
      a, t, e.QUOTE_STRING_MODE, e.C_NUMBER_MODE, i, e.inherit(e.TITLE_MODE, {
        begin: "^[_a-z][\\w']*"
      }), n, {
        begin: "->|<-"
      }]
  ...
  function m(e) {
    ...
    o = (o.contains = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, c, d, g, l, e.REGEXP_MODE], o.contains.concat([e.C_BLOCK_COMMENT_MODE, e.C_LINE_COMMENT_MODE]));
    return {
      ...
      e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, c, d, g, e.C_LINE_COMMENT_MODE, e.COMMENT("/\\*\\*", "\\*/", {
        relevance: 0,
        contains: [{
          className: "doctag",
          begin: "@[A-Za-z]+",
  ...
  function p(e) {
    ...
    c = o;
    return c.variants[1].contains = [o],
  ...
  function v(e) {
    ...
    i = [i, e.HASH_COMMENT_MODE, e.COMMENT("^\\=\\w", "\\=cut", {
      endsWithParent: !0
    }), t, {
      className: "string",
      contains: s,
    ...
    return t.contains = [s],
    {
      ...
      s, {
        ...
        },
        {
          ...
          endsParent: !0,
          keywords: n,
          contains: ["self", s, i, e.C_BLOCK_COMMENT_MODE, {
            begin: ":"
          }],
          illegal: /["']/
        }],
  ...
  D = function(t) {
    ...
    function m(e) {
      ...
      return function e(n, a) {
        for (var t = n.firstChild; t; t = t.nextSibling) 3 === t.nodeType ? a += t.nodeValue.length: 1 === t.nodeType && (i.push({
          ...
          offset: a,
          node: t
        }), a = e(t, a), u(t).match(/br|hr|img|input/) || i.push({
          event: "stop",
          offset: a,
          node: t
        }));
    ...
    function _(e, n, a) {
      ...
      function c(e) { ("start" === e.event ? l: o)(e.node)
      }
      for (; e.length || n.length;) {
        var d = r();
        if (i += S(a.substring(t, d[0].offset)), t = d[0].offset, d === e) {
          for (s.reverse().forEach(o); c(d.splice(0, 1)[0]), (d = r()) === e && d.length && d[0].offset === t;);
          s.reverse().forEach(l)
        } else "start" === d[0].event ? s.push(d[0].node) : s.pop(),
        c(d.splice(0, 1)[0])
      }
    ...
    function p(e) {
      if (a && !e.langApiRestored) {
        ...
        a) e[n] && (e[a[n]] = e[n]); (e.contains || []).concat(e.variants || []).forEach(p)
      }
    }
    function f(n, t) {
      var i = {};
    ...
    function A(n, e, t, a) {
      var i = e;
      function s(e, n, a, t) {
        return a || "" !== n ? e ? (t = '<span class="' + (t ? "": x.classPrefix), (t += e + '">') + n + (a ? "": O)) : n: ""
      }
      function r() {
        var e, n, a, t, i;
        if (!_.keywords) return S(E);
        for (a = "", _.lexemesRe.lastIndex = e = 0, n = _.lexemesRe.exec(E); n;) a += S(E.substring(e, n.index)),
        t = _,
        i = n,
        i = m.case_insensitive ? i[0].toLowerCase() : i[0],
        (t = t.keywords.hasOwnProperty(i) && t.keywords[i]) ? (N += t[1], a += s(t[0], S(n[0]))) : a += S(n[0]),
      ...
      function l() {
        var e, n;
        p += null != _.subLanguage ? (n = "string" == typeof _.subLanguage) && !w[_.subLanguage] ? S(E) : (e = n ? A(_.subLanguage, E, !0, b[_.subLanguage]) : k(E, _.subLanguage.length ? _.subLanguage: void 0), 0 < _.relevance && (N += e.relevance), n && (b[_.subLanguage] = e.top), s(e.language, e.value, !1, !0)) : r(),
        E = ""
      }
      function o(e) {
      ...
      function d(e) {
        ...
        if (a) {
          e = _;
          for (e.skip ? E += n: (e.returnEnd || e.excludeEnd || (E += n), l(), e.excludeEnd && (E = n)); _.className && (p += O), _.skip || _.subLanguage || (N += _.relevance), (_ = _.parent) !== a.parent;);
          return a.starts && (a.endSameAsBegin && (a.starts.endRe = a.endRe), o(a.starts)),
      ...
      function u(e, n) {
        var a = n && n[0];
        if (E += e, null == a) return l(),
        0;
        if ("begin" == g.type && "end" == n.type && g.index == n.index && "" === a) return E += i.slice(n.index, n.index + 1),
        1;
        if ("illegal" === g.type && "" === a) return E += i.slice(n.index, n.index + 1),
        1;
      ...
      var m = R(n);
      if (!m) throw console.error(C.replace("{}", n)),
      new Error('Unknown language: "' + n + '"');
      T(m);
      for (var _ = a || m,
      b = {},
      p = "",
      f = _; f !== m; f = f.parent) f.className && (p = s(f.className, "", !0) + p);
      var E = "",
      N = 0;
      try {
        for (var h, y, v = 0;;) {
          if (_.terminators.lastIndex = v, !(h = _.terminators.exec(i))) break;
          y = u(i.substring(v, h.index), h),
          v = h.index + y
        }
        for (u(i.substr(v)), f = _; f.parent; f = f.parent) f.className && (p += O);
        return {
          relevance: N,
          value: p,
          illegal: !1,
    ...
    function k(a, e) {
      ...
      i = t;
      return e.filter(R).filter(v).forEach(function(e) {
        var n = A(e, a, !1);
        n.language = e,
    ...
    function E(e) {
      return x.tabReplace || x.useBR ? e.replace(i,
      function(e, n) {
    ...
    function N(e) {
      var n, a, t, i, s = function(e) {
        ...
        if (r += e.parentNode ? e.parentNode.className: "", a = l.exec(r)) return (s = R(a[1])) || (console.warn(C.replace("{}", a[1])), console.warn("Falling back to no-highlight mode for this block.", e)),
        s ? a[1] : "no-highlight";
        for (n = 0, t = (r = r.split(/\s+/)).length; n < t; n++) if (c(i = r[n]) || R(i)) return i
      } (e);
      c(s) || (x.useBR ? (a = document.createElement("div")).innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n") : a = e, i = a.textContent, n = s ? A(s, i, !0) : k(i), (a = m(a)).length && ((t = document.createElement("div")).innerHTML = n.value, n.value = _(a, m(t), i)), n.value = E(n.value), e.innerHTML = n.value, e.className = (a = e.className, t = s, i = n.language, t = t ? r[t] : i, i = [a.trim()], a.match(/\bhljs\b/) || i.push("hljs"), -1 === a.indexOf(t) && i.push(t), i.join(" ").trim()), e.result = {
        language: n.language,
        re: n.relevance
      },
    ...
    t.registerLanguage = function(n, e) {
      ...
      try {
        ...
        if (console.error("Language definition for '{}' could not be registered.".replace("{}", n)), !M) throw e;
        console.error(e),
        a = y
      }
      p(w[n] = a),
  ...
  L = "object" == typeof window && window || "object" == typeof self && self,
  void 0 === I || I.nodeType ? L && (L.hljs = D({}), "function" == typeof define) && define.amd && define([],
  function() {
    return L.hljs
  }) : D(I); !
  function() {
